...
export const environment = {
  production: false,
  URL_API: 'https://logitech.intrared.net/ap/pre-production/pad/v2/backend/api',
  ...
  // URL_API: 'http://f1d9ea5d.ngrok.io/api',
  ...
  SCA_URL: 'https://logitech.intrared.net/ap/pre-production/sca/backend/api/v1',
